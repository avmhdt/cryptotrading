...
from private.systems.crypto_2024.accounts.account_forecast import accountForecast
from private.systems.crypto_2024.accounts.curves.dict_of_account_curves import (
    dictOfAccountCurves,
...
class accountTradingRules(accountForecast):
    ...
    def pandl_for_trading_rule_weighted(
        ...
        account_curve = accountCurveGroup(
            dict_of_pandl_by_instrument, capital=capital, weighted=True, frequency=self.barsize,
        )
    ...
    def pandl_for_trading_rule_unweighted(
        ...
        account_curve = accountCurveGroup(
            dict_of_pandl_by_instrument, capital=capital, weighted=False, frequency=self.barsize,
        )
    ...
    def pandl_for_instrument_rules(
        ...
        account_curve = accountCurveGroup(
            dict_of_pandl_by_rule, capital=capital, weighted=True, frequency=self.barsize,
        )
    ...
    def pandl_for_instrument_rules_unweighted(
        ...
        account_curve = accountCurveGroup(
            dict_of_pandl_by_rule, capital=capital, weighted=False, frequency=self.barsize,
        )
