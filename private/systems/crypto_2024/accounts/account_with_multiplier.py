...
from private.systems.crypto_2024.accounts.account_portfolio import accountPortfolio
from private.systems.crypto_2024.accounts.account_buffering_system import accountBufferingSystemLevel
...
class accountWithMultiplier(accountPortfolio, accountBufferingSystemLevel):
    ...
    def portfolio_with_multiplier(self, delayfill=True, roundpositions=True):
        ...
        port_pandl = accountCurveGroup(port_pandl, capital=capital, weighted=True, frequency=self.barsize)
