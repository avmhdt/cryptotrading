...
def crypto_system(
    sim_data=arg_not_supplied, config_filename="private.systems.crypto_2024.logit_breakout_config.yaml",
...
if __name__ == "__main__":
    ...
    curve = portfolio.percent.curve()
    drawdown = portfolio.percent.drawdown()
