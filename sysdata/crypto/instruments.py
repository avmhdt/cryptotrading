...
from sysobjects.instruments import (
    ...
    listOfCryptoInstrumentWithMetaData,
)
from syslogging.logger import *

USE_CHILD_CLASS_ERROR = "You need to use a child class of cryptoInstrumentData"


class cryptoInstrumentData(baseData):
    """
    ...
    def __repr__(self):
        return "cryptoInstrumentData base class - DO NOT USE"

    def __init__(self, log=get_logger("cryptoInstrumentData")):
    ...
    def get_all_instrument_data_as_list_of_instrument_objects(
        ...
        list_of_instrument_objects = listOfCryptoInstrumentWithMetaData(
            all_instrument_objects
        )
    ...
    def get_instrument_data(
        ...
        if self.is_code_in_data(instrument_code):
            ...
            return cryptoInstrumentWithMetaData.create_empty()
    ...
    def add_instrument_data(
        self,
        instrument_object: cryptoInstrumentWithMetaData,
    ...
    def _add_instrument_data_without_checking_for_existing_entry(
        self, instrument_object: cryptoInstrumentWithMetaData
    ):
        raise NotImplementedError(USE_CHILD_CLASS_ERROR)
